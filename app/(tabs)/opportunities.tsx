      ...
      >
        <View className="p-6 gap-6">
          ...
          <View className="gap-2">
            <Text className="text-3xl font-bold text-foreground">Earning Opportunities</Text>
          ...
          <View className="flex-row gap-3">
            <View
              className="flex-1 rounded-xl p-4 gap-1"
              style={{ backgroundColor: colors.surface }}
            >
              <Text className="text-xs text-muted font-semibold">Available Points</Text>
            ...
            <View
              ...
              style={{ backgroundColor: colors.surface }}
            >
              <Text className="text-xs text-muted font-semibold">Expiring Soon</Text>
          ...
          {/* Category Filter */}
          <View className="gap-2">
            <Text className="text-sm font-semibold text-foreground">Filter by Category</Text>
          ...
          {error && (
            ...
            >
              <Text className="text-sm font-semibold text-error">⚠️ Error</Text>
          ...
          {isLoading && (
            <View className="items-center py-8 gap-2">
              ...
              <Text className="text-sm text-muted">Loading opportunities...</Text>
            </View>
          )}
          ...
          {!isLoading && filteredOpportunities.length === 0 && (
            <View className="items-center py-8 gap-2">
              ...
              <Text className="text-sm font-semibold text-foreground">No opportunities</Text>
            ...
            <View className="gap-3">
              {filteredOpportunities.map((opp) => (
                ...
                >
                  ...
                  {/* Time Remaining */}
                  <View className="flex-row items-center gap-2 py-2 px-2 rounded-lg" style={{ backgroundColor: colors.background }}>
                  ...
                  {opp.isCompleted && (
                    <View className="bg-success rounded-lg py-2 items-center opacity-50">
